...
// call this function to retrieve an item by its id
const get_user_item_list_ = async (req, res) => {
  /*
    This retrieves the api version passed by the developer and
    calls the version of the function in that version
  if the api version does not exit it sends an error message.
  */
  ...
  const version = req.body.version;
  if (version === "v1.0") return get_user_item_list(req, res);
};

// call this function to get a list of items posted by everyone
const get_item_list_ = (req, res) => {
  /*
    This retrieves the api version passed by the developer and
    calls the version of the function in that version
  if the api version does not exit it sends an error message.
  */
  ...
  const version = req.body.version;
  if (version === "v1.0") return get_item_list(req, res);
};
